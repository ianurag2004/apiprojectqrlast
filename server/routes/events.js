...
const {
  ...
  submitEvent, approveEvent, deleteEvent, toggleRegistration,
...
router.patch('/:id/registration-toggle', protect, authorize('organizer','hod','super_admin'), toggleRegistration);
